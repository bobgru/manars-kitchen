...
Provides `worker view <name>` and `GET /api/workers/:name` to display a worker's complete profile, including status, employment, hours, skills, prefs, pairings, seniority, and cross-training. Works for both active and inactive workers.
