...
Resolves a worker name (= username) to a `WorkerId`, distinguishing not-found from not-a-worker. Used by all name-based worker commands and their REST endpoints.
